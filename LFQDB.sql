...
CREATE TABLE IF NOT EXISTS `LFQDB`.`Run` (
  `idSamples` INT NOT NULL COMMENT '',
  ...
  PRIMARY KEY (`idSamples`, `Experiment_idExperiment`)  COMMENT '',
  INDEX `fk_Samples_Experiment1_idx` (`Experiment_idExperiment` ASC)  COMMENT '',
  CONSTRAINT `fk_Samples_Experiment1`
...
CREATE TABLE IF NOT EXISTS `LFQDB`.`QuantProtein` (
  ...
  `Samples_idSamples` INT NOT NULL COMMENT '',
  `Samples_Experiment_idExperiment` INT NOT NULL COMMENT '',
  `Protein_idProtein` INT NOT NULL COMMENT '',
  PRIMARY KEY (`idQuantProtein`, `Samples_idSamples`, `Samples_Experiment_idExperiment`, `Protein_idProtein`)  COMMENT '',
  INDEX `fk_QuantProtein_Samples1_idx` (`Samples_idSamples` ASC, `Samples_Experiment_idExperiment` ASC)  COMMENT '',
  INDEX `fk_QuantProtein_Protein1_idx` (`Protein_idProtein` ASC)  COMMENT '',
  CONSTRAINT `fk_QuantProtein_Samples1`
    FOREIGN KEY (`Samples_idSamples` , `Samples_Experiment_idExperiment`)
    REFERENCES `LFQDB`.`Run` (`idSamples` , `Experiment_idExperiment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `LFQDB`.`QuantPeptide` (
  ...
  CONSTRAINT `fk_QuantPeptide_QuantProtein1`
    FOREIGN KEY (`QuantProtein_idQuantProtein`)
    REFERENCES `LFQDB`.`QuantProtein` (`idQuantProtein`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_QuantPeptide_Peptide1`
...
CREATE TABLE IF NOT EXISTS `LFQDB`.`Precursor` (
  ...
  CONSTRAINT `fk_Precursor_Peptide1`
    FOREIGN KEY (`Peptide_idPeptide`)
    REFERENCES `LFQDB`.`Peptide` (`idPeptide`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `LFQDB`.`QuantFragments` (
  ...
  PRIMARY KEY (`idQuantFragment`, `QuantPrecursorDIA_idQuantPrecursorDIA`)  COMMENT '',
